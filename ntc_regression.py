...
NTC10K_RES = np.array([
    1214600, 844390, 592430, 419380, 299480,
    ...
    300.1, 260.1],dtype=np.float64)

NTC10K_TEMP = np.array([
    -55, -50, -45, -40, -35,
    -30, -25, -20, -15, -10,
    -5, 0, 5, 10, 15,
    20, 25, 30, 35, 40,
...
x = np.linspace(start=0, stop=1250000, num=1000)
